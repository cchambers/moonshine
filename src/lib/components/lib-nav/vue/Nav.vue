<template>
  <div v-cloak>
    <div class="show-nav nav-icon" @click="toggleNav" v-bind:class="{ tip: !usedShortcut }">
    ...
    <div class="lib-nav">
      <nav>
        <div class="primary" ref="primary">
          <!-- <div @click="closeNav" class="go-back">
          </div> -->
          <div id="nav-search">
          ...
          <div id="prod-toggle"
          :class="{ active: prodFilter }" @click="toggleFilter">
            <div class="px30">
          ...
          <div class="documentation pad-x-quarter pad-y" @click="goHome">
