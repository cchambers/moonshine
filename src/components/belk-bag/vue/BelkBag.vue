...
export default {
  ...
  data() {
    return {
      items: [
        {
          thumb_image: 'https://belk.scene7.com/is/image/Belk?layer=0&src=1803007_MF04LX5CVJ_A_033&$DWP_THUMB_PDP_DESKTOP$',
          title: 'Womens Ruffle Cheetah Print Blouse ',
          pid: '0438670601300',
          category: null,
          name: 'Women\'s Ruffle Cheetah Print Blouse ',
          brand: 'MICHAEL Michael Kors',
          qty: 1,
          code: '0193599990248',
          url: '/s/Belk/p/michael-michael-kors-womens-ruffle-cheetah-print-blouse-/0438670601300.html',
          discountType: null,
          color: 'Gunmetal',
          size: 'M',
          sale_price: 88,
        ...
        {
          thumb_image: 'https://belk.scene7.com/is/image/Belk?layer=0&src=1803715_CS11818BK_A_401&$DWP_THUMB_PDP_DESKTOP$',
          title: 'Womens Roll Tab Honeycomb LUREX® Shirt',
          pid: '0438672186355',
          category: null,
          name: 'Women\'s Roll Tab Honeycomb LUREX® Shirt',
          brand: 'Kim Rogers®',
          qty: 1,
          code: '0190415613459',
          url: '/s/Belk/p/kim-rogers-womens-roll-tab-honeycomb-lurex-shirt/0438672186355.html',
