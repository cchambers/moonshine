        ...
        if (xhr.readyState === DONE) {
          if (xhr.status === OK) {
            ...
            if (response.match('<html')) {
              ...
              var res = Vue.compile(updateCode.innerHTML);
              new Vue({
                render: res.render,
